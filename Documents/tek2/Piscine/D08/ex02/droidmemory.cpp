...
// Last update Wed Jan 16 15:44:13 2013 lyoma guillou
//
...
bool			DroidMemory::operator==(DroidMemory const &other)
{
  return (this->FingerPrint == other.FingerPrint && this->Exp == other.Exp);
}
