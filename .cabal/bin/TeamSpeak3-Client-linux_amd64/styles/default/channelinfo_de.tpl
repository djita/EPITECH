...
<table id="info">
  ...
  <tr><td class="label">Ben&ouml;tigte Talk Power:</td><td class="red"><img src="iconpath:16x16_moderated.png" height="12" width="12" alt="" title="Fordere Talk Power an um in diesem Channel zu sprechen." />&nbsp;&nbsp;%%?CHANNEL_NEEDED_TALK_POWER%%</td></tr>
  <tr>
